...
// TODO: remove this cleaning when leave Dawntrail
if (localStorage.getItem('ffxiv-gearing.archive-cleaned') === null) {
  ...
  localStorage.setItem('ffxiv-gearing.archive-cleaned', 'true');
}
